...
print("=== KENTUCKY DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/kentucky_candidates_1983_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/kentucky_candidates_1983_2024_cleaned_20250820_230734.xlsx')
