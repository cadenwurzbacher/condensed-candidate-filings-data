...
print("=== NEW MEXICO DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_html('data/raw/new_mexico_candidates_2024.xls')[0]
...
# Load processed data
processed = pd.read_excel('data/processed/new_mexico_candidates_2024_cleaned_20250820_131722.xlsx')
