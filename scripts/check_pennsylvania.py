...
print("=== PENNSYLVANIA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/pennsylvania_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/pennsylvania_merged_temp_cleaned_20250820_132209.xlsx')
