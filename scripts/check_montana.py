...
print("=== MONTANA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/montana_candidates_2020_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/montana_candidates_2020_2024_cleaned_20250820_131722.xlsx')
