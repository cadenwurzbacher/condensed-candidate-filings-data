...
print("=== SOUTH DAKOTA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/south_dakota_candidates_2024.xls')
...
# Load processed data
processed = pd.read_excel('data/processed/south_dakota_candidates_2024_cleaned_20250820_132214.xlsx')
