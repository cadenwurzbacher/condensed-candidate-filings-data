...
print("=== IOWA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/iowa_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/iowa_candidates_2024_cleaned_20250820_180225.xlsx')
