...
print("=== OKLAHOMA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/oklahoma_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/oklahoma_candidates_2024_cleaned_20250820_132206.xlsx')
