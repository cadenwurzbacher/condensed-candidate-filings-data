...
print("=== NORTH CAROLINA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_csv('data/raw/north_carolina_candidates_2024.csv')
...
# Load processed data
processed = pd.read_excel('data/processed/north_carolina_merged_temp_cleaned_20250820_132154.xlsx')
