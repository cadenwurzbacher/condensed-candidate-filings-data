...
print("=== WEST VIRGINIA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/west_virginia_candidates_2012_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/west_virginia_candidates_2012_2024_cleaned_20250820_132215.xlsx')
