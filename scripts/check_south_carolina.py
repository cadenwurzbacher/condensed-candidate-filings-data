...
print("=== SOUTH CAROLINA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/south_carolina_candidates_2018_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/south_carolina_candidates_2018_2024_cleaned_20250820_132212.xlsx')
