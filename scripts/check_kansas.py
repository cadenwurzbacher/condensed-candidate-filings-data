...
print("=== KANSAS DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/kansas_candidates_2002_2026.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/kansas_candidates_2002_2026_cleaned_20250820_181033.xlsx')
