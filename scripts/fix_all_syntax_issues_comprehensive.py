#!/usr/bin/env python3
"""
Comprehensive fix for all syntax issues in state cleaner files.
This script addresses:
1. Stray 'return df' statements outside functions
2. Missing 'self.' prefixes on method definitions
3. Indentation errors
4. Any other syntax issues
"""
...
def fix_syntax_issues_comprehensive(file_path):
    """Fix all syntax issues in a single state cleaner file."""
...
def main():
    ...
    print("🔧 Comprehensive syntax fix for all state cleaner files...")
    print("=" * 60)
    ...
    for file_path in state_cleaner_files:
        if fix_syntax_issues_comprehensive(file_path):
            fixed_count += 1
    
    print()
    print("=" * 60)
    print(f"🎉 Comprehensive syntax fix complete!")
