...
print("=== NEW YORK DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_csv('data/raw/new_york_candidates_1982_2024.csv')
...
# Load processed data
processed = pd.read_excel('data/processed/new_york_candidates_1982_2024_cleaned_20250820_132117.xlsx')
