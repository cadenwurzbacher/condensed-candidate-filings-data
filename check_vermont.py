...
print("=== VERMONT DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/vermont_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/vermont_candidates_2024_cleaned_20250820_132214.xlsx')
