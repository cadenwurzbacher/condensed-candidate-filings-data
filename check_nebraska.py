...
print("=== NEBRASKA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/nebraska_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/nebraska_candidates_2024_cleaned_20250820_131722.xlsx')
