...
print("=== MARYLAND DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/maryland_candidates_2016.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/maryland_merged_temp_cleaned_20250820_131721.xlsx')
