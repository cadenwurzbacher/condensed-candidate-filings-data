...
print("=== LOUISIANA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/louisiana_candidates_2016_2025.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/louisiana_candidates_2016_2025_cleaned_20250820_131709.xlsx')
