...
class IowaCleaner(BaseStateCleaner):
    ...
    def __init__(self):
        ...
        self.county_mappings = {
            ...
            'Buena Vista': 'Buena Vista County',
        ...
        self.office_mappings = {
            ...
            'REGENT OF THE UNIVERSITY OF IOWA': 'Regent of the University of Iowa',
    ...
    def _clean_state_specific_structure(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Clean addresses (Iowa-specific logic)
        if 'address' in df.columns:
            df['address'] = df['address'].apply(self._clean_iowa_address)
    ...
    def _clean_iowa_address(self, address: str) -> str:
        """
        Clean Iowa-specific address formats.
        ...
        # Iowa-specific address cleaning logic
        address = str(address).strip()
        
        # Handle common Iowa address patterns
