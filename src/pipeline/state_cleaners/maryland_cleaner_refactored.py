#!/usr/bin/env python3
"""
Maryland State Cleaner - Refactored Version
...
class MarylandCleaner(BaseStateCleaner):
    ...
    def __init__(self):
        ...
        # Maryland-specific county mappings
        ...
        self.office_mappings = {
            ...
            'REGENT OF THE UNIVERSITY OF MARYLAND': 'Regent of the University of Maryland',
    ...
    def clean_data(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Clean Maryland candidate filing data.
        ...
        """
        self.logger.info(f"Starting Maryland data cleaning")
    ...
    def _clean_state_specific_structure(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Clean addresses (Maryland-specific logic)
        if 'address' in df.columns:
            df['address'] = df['address'].apply(self._clean_maryland_address)
    ...
    def _clean_state_specific_content(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Maryland-specific formatting
        df = self._apply_maryland_formatting(df)
    ...
    def _parse_names(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        Maryland-specific name parsing logic - Old Line State naming patterns.
        """
        ...
        # Maryland name parsing - handles mid-atlantic naming patterns
    ...
    def _clean_maryland_name(self, name: str) -> str:
        """
        Clean Maryland-specific name formats.
        ...
        # Maryland-specific name cleaning logic
        name = str(name).strip()
        
        # Handle common Maryland name patterns
    ...
    def _clean_maryland_address(self, address: str) -> str:
        """
        Clean Maryland-specific address formats.
        ...
        # Maryland-specific address cleaning logic
        address = str(address).strip()
        
        # Handle common Maryland address patterns
        # (e.g., PO Box formats, rural route formats, Baltimore city formats)
    ...
    def _clean_maryland_district(self, district: str) -> str:
        """
        Clean Maryland-specific district formats.
        ...
        # Maryland-specific district cleaning logic
        district = str(district).strip()
        
        # Handle common Maryland district patterns
    ...
    def _apply_maryland_formatting(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Apply Maryland-specific formatting rules.
        ...
        Returns:
            Formatted DataFrame
        """
        # Maryland-specific formatting logic
