...
class OklahomaCleaner(BaseStateCleaner):
    ...
    def __init__(self):
        ...
        # Oklahoma-specific county mappings
        self.county_mappings = {
            'Adair': 'Adair County',
            'Alfalfa': 'Alfalfa County',
            'Atoka': 'Atoka County',
            'Beaver': 'Beaver County',
            'Beckham': 'Beckham County',
            ...
            'Garvin': 'Garvin County',
            'Grady': 'Grady County',
            'Grant': 'Grant County',
            'Greer': 'Greer County',
            'Harmon': 'Harmon County',
        ...
        self.office_mappings = {
            ...
            'REGENT OF THE UNIVERSITY OF OKLAHOMA': 'Regent of the University of Oklahoma',
    ...
    def _clean_state_specific_structure(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Clean addresses (Oklahoma-specific logic)
        if 'address' in df.columns:
            df['address'] = df['address'].apply(self._clean_oklahoma_address)
    ...
    def _clean_oklahoma_address(self, address: str) -> str:
        """
        Clean Oklahoma-specific address formats.
        ...
        # Oklahoma-specific address cleaning logic
        address = str(address).strip()
        
        # Handle common Oklahoma address patterns
