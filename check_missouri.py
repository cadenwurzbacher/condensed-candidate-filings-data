...
print("=== MISSOURI DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/missouri_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/missouri_candidates_2024_cleaned_20250820_131722.xlsx')
