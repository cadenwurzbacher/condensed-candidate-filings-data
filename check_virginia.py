...
print("=== VIRGINIA DATA COMPLETENESS ===")

# Load raw data
raw = pd.read_excel('data/raw/virginia_candidates_2024.xlsx')
...
# Load processed data
processed = pd.read_excel('data/processed/virginia_merged_temp_cleaned_20250820_132223.xlsx')
